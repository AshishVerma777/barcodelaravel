...
<body>
    <div class="container">
        <div class="container-fluid">
            <div class="box">
                {{-- top-header --}}
                <div class="row border-bottom border-2 border-dark mt-2 borders mt-2 ">
                ...
                {{-- table --}}
                <div class="brand-informations  border-bottom border-2 border-dark mt-2 borders">
                    <div class="row">
                        <div class="col-lg-6 border-end border-2 border-dark">
                            <div class=" d-flex border-bottom border-2 border-dark mt-2 ">
                                <div class="brand-name fw-bold">
                                    Batch/Lot No
                                </div>
                                <div class="product-name ">
