    ...
    <div class="container">
        <div class="container-fluid">
            <div class="box">
                ...
                {{-- table --}}
                <div class="brand-informations  border-bottom border-2 border-dark  borderss">
                    <div class="row">
                ...
                <div class="brand-information p-2 border-bottom border-2 border-dark  borders">
                    <div class="row ">
                        <div class="brand-info">
                            <div class="brand-name fw-bold">
                                Manufacturer
                ...
                <div class="brand-informations  border-bottom border-2 border-dark ">
                    <div class="row">
                        <div class="col-lg-6 border-end border-2 border-dark ">
                            <div class=" d-flex border-bottom border-2 border-dark brand-info table">
                                <div class="brand-name fw-bold">
