            ...
            <div class="col-md-6">
                ...
                @foreach ($product->containers as $container)
                   <div class="card-body">
                            ...
                            <p class="card-text">Total Number Container: {{ $product->container_no }}</p>
                                @foreach ($product->containers as $container)

                            <p class="card-text">Container {{ $loop->index + 1 }} {{ $container->container_no }}  {{ $container->status }}</p>
                            {{-- <p class="card-text">Container</p> --}}
                        @endforeach

                            {{-- <p class="card-text">Container No.: {{ $product->containers->container_no }}</p> --}}
