...
<style>
 ...
 body {
   ...
   background: -webkit-linear-gradient(to top, #c4beb6c3 10%, #3a5d78 100%);
   background: -moz-linear-gradient(to top, #c4beb6c3 10%, #3a5d78 100%);
   background: -o-linear-gradient(to top,#c4beb6c3 10%, #3a5d78 100%);
 ...
 h5 {
   ...
   color: #fff;
   font-weight: 2rem;
   filter: drop-shadow(5px 5px 20px red),
 ...
 input[type="text"], input[type="email"], input[type="password"] {
   ...
   margin-bottom: 4%;
   padding: 0.8em;
   border: solid 1px rgba(199, 190, 190, 0.572);
...
<body>
    <div class="main-w3layouts wrapper">
        ...
        <h5>Welcome to Warehouse and Labeling Management</h5>
