    ...
    <div class="container-fluid background-color">
        ...
        <div class="row justify-content-md-center">
            ...
            {{-- <div class="row pb-2 m-3">
                  ...
                  <div class="col-12 col-lg-6 d-flex justify-content-between align-items-center">
                    <div class="input-field w-100 d-flex flex-column flex-lg-row justify-content-between align-items-center">
                ...
                <div class="container  mb-4 d-flex align-items-center justify-content-center">
                    <div class="row d-flex align-items-center justify-content-between w-100">
                        ...
                        <div class="col-md-4 text-center">
                            <h3>Enter Barcode No</h3>
                            <input type="text" class="form-control" placeholder="Barcode No">
                        </div>
                    </div>
                </div>
